                            ...
                            productDetail.product.map((item, index) => {
                                return (
                                    <div className='itemsImageProductPageOne' key={item.id || index}>
                                        <div className='imgBlockitemsImageProductPageOne'>
                                            <img src={item.imageUrl} alt={item.name} className='productImageProduct' />
                                        </div>
                                        ...
                                        <div className='freeDeliveryProductPage'>Free Delivery by Amazon</div>
                                        </div>
                                        </div>
                                );
